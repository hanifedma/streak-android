...
object Strings {
    ...
    private val ko: Map<String, String> = mapOf(
        ...
        "reorder.hint" to "습관을 길게 누른 뒤 끌어서 순서를 바꾸세요.",
        "reorder.up" to "위로",
        "reorder.down" to "아래로",
        "reorder.done" to "완료",
        ...
        // --- start over (keeps the habits, clears their history) ---
        "settings.reset" to "다시 시작",
        "settings.resetBtn" to "오늘부터 다시 시작",
        "settings.resetHint" to "습관과 피하기는 그대로 두고 기록만 지웁니다. 모두 오늘 만든 것처럼 1일차부터 다시 시작합니다.",
        "settings.resetBackupHint" to "되돌릴 수 없습니다. 기록을 남기고 싶다면 먼저 백업을 내보내세요.",
        "settings.resetConfirm" to "모든 습관을 오늘부터 다시 시작할까요?",
        "settings.resetDetail" to "습관 {n}개의 체크와 어긴 기록, 연속 기록이 모두 지워지고 오늘부터 다시 시작합니다. 습관 자체는 삭제되지 않습니다.",
        "settings.resetDetail.one" to "습관 {n}개의 체크와 어긴 기록, 연속 기록이 모두 지워지고 오늘부터 다시 시작합니다. 습관 자체는 삭제되지 않습니다.",
        "settings.resetYes" to "다시 시작",
        ...
        "toast.reset" to "습관 {n}개를 오늘부터 다시 시작합니다",
        "toast.reset.one" to "습관 {n}개를 오늘부터 다시 시작합니다",
        "toast.resetNone" to "이미 모두 오늘부터 시작하고 있습니다",
        "toast.resetUndone" to "다시 시작을 취소했습니다",
    ...
    private val en: Map<String, String> = mapOf(
        ...
        "reorder.hint" to "Press and hold a habit, then drag it to reorder.",
        ...
        "settings.reset" to "Start over",
        "settings.resetBtn" to "Restart everything from today",
        "settings.resetHint" to "Keeps every habit and avoid, clears their history. All of them start again at day 1, as if you had created them today.",
        "settings.resetBackupHint" to "This can't be undone. Export a backup first if you want to keep the history.",
        "settings.resetConfirm" to "Restart every habit from today?",
        "settings.resetDetail" to "Every tick, slip and streak across {n} habits is erased and they all begin again today. The habits themselves are kept.",
        "settings.resetDetail.one" to "Every tick, slip and streak on {n} habit is erased and it begins again today. The habit itself is kept.",
        "settings.resetYes" to "Start over",
        ...
        "toast.reset" to "{n} habits restarted from today",
        "toast.reset.one" to "{n} habit restarted from today",
        "toast.resetNone" to "Everything already starts today",
        "toast.resetUndone" to "Restart undone",
